...
const CONFIG = {
    ...
    projectName: "OBSIDIAN-MAGICLINK",
    projectSubtitle: "OBSIDIAN-MAGICLINK WIKI",
    description: "Official Documentation and Wiki for obsidian-magiclink",

    // Versioning Settings
    versioning: {
        type: "local",
        manualVersion: "v1.0.1",
        manualDate: "2026-02-07"
    },

    // GitHub Repository
    repo: "infinition/obsidian-magiclink",
    branch: "main",
    ...
    // Footer
    footerText: "© 2026 OBSIDIAN-MAGICLINK WIKI - All rights reserved",
    ...
    social: {
        discord: null,
        reddit: null,
        github: "https://github.com/infinition/obsidian-magiclink", // Virgule respectée par le script
    ...
    badges: {
        ...
        redditLabel: "REDDIT",
        githubLabel: "OBSIDIAN-MAGICLINK"
    }
};